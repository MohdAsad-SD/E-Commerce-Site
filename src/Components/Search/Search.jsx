...
const Search = ({searchtext,setsearchtext,search,setsearch}) => {
  return (
    <div className='py-5 px-4 md:px-15 mt-1 md:mt-1 w-screen'  >
      <div className='flex justify-center items-center border-t border-b border-gray-500 py-5 px-4 md:px-15 w-full gap-2'>
        ...
        <input value={searchtext} onChange={(e)=>setsearchtext(e.target.value)} type="text" placeholder='Search' className='md:p-2 w-full p-2 rounded-full border outline-none'  />
